...
# TodosTestsAreDemo.Group2/whenDown()
...
```
AssertionError: expected 'Repair the bike' to equal 'Buy groceries for next week'
	  at Object.equal [oldFunction.apply(null, args);] (http://localhost:3000TestsAreDemoFunctions.tsx:124:29)
	  at async Group2.whenDown [await tad.assertWaitable.equal(tad.screenCapturing.getByTestId(uiApiTodoItem(0).testids.onToggle).textContent, "Buy groceries for next week");] (http://localhost:3000TodosTestsAreDemo.tsx:133:17)
```
...
TodosTestsAreDemo.Group2/whenDown/Todos_todoItem_0_TodoItem__onDown.png <br/>
![](Todos_todoItem_0_TodoItem__onDown.png)

</details>
</td>
<td>

![](Todos_todoItem_0_TodoItem__onDown_small.png)
...
TodosTestsAreDemo.Group2/whenDown/Todos_todoItem_0_TodoItem__onToggle.png <br/>
