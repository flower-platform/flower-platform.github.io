...
# TodosTestsAreDemo.Group2/whenUp()
...
```
AssertionError: expected 'Prepare birthday cake' to equal 'Repair the bike'
	  at Object.equal [oldFunction.apply(null, args);] (http://localhost:3000TestsAreDemoFunctions.tsx:124:29)
	  at async Group2.whenUp [await tad.assertWaitable.equal(tad.screenCapturing.getByTestId(uiApiTodoItem(0).testids.onToggle).textContent, "Repair the bike");] (http://localhost:3000TodosTestsAreDemo.tsx:126:17)
```
...
TodosTestsAreDemo.Group2/whenUp/Todos_todoItem_1_TodoItem_1_onUp.png <br/>
![](Todos_todoItem_1_TodoItem_1_onUp.png)

</details>
</td>
<td>

![](Todos_todoItem_1_TodoItem_1_onUp_small.png)
...
TodosTestsAreDemo.Group2/whenUp/Todos_todoItem_0_TodoItem__onToggle.png <br/>
