...
`]}),`
`]})]})}function d(r={}){const{wrapper:n}=Object.assign({},i(),r.components);return n?e.jsx(n,{...r,children:e.jsx(o,{...r})}):o(r)}const c=()=>{throw new Error("Docs-only story")};c.parameters={docsOnly:!0};const s={title:"Internal/Use moment/Doc",parameters:{viewMode:"docs",previewTabs:{canvas:{hidden:!0}}},tags:["stories-mdx"],includeStories:["__page"]};s.parameters=s.parameters||{};s.parameters.docs={...s.parameters.docs||{},page:d};const _=["__page"];export{_ as __namedExportsOrder,c as __page,s as default};
//# sourceMappingURL=UseMoment.stories-e03db93e.js.map
